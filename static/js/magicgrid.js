...
var masnorys = document.getElementsByTagName('img');     // 벽돌형 레이아웃 형태

for (let i = 0; i < masnorys.length; i++){
    masnorys[i].addEventListener('load', function () {
        magicGrid.positionItems();
    }, false);
}       // load 가 되었을때 재배치를 하게 해준다
